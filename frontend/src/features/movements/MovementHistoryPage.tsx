    ...
    <>
      <header className="mb-7">
        ...
        <p className="mt-2 max-w-2xl text-slate-600">
          Consulta entradas y salidas por producto y periodo.
        </p>
      </header>
        ...
        {!productId ? (
          <div className="grid place-items-center px-6 py-16 text-center">
            ...
            <p className="mt-1 text-sm text-slate-500">
              Su historial aparecera en esta seccion.
            </p>
          </div>
        ) : null}
        ...
        <div className="divide-y divide-slate-100">
          {movements.data?.content.map((movement) => {
            ...
            return (
              ...
              >
                <span
                  className={`grid size-11 shrink-0 place-items-center rounded-xl ${entry ? "bg-emerald-100 text-emerald-700" : "bg-red-100 text-red-700"}`}
                >
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
                    <p className="font-semibold">
                      {entry ? "Entrada" : "Salida"} de {movement.quantity}{" "}
                      unidades
                    </p>
                    <time
                  ...
                  <p className="mt-2 text-xs font-medium text-slate-500">
                    Saldo resultante: {movement.balanceAfter}
                  </p>
                </div>
              </article>
            );
